...
resource "azuread_app_role_assignment" "external_directory_developer_to_administrator" {
  provider            = azuread.external_directory
  app_role_id         = azuread_application_app_role.external_directory_administrator.role_id
...
resource "azuread_app_role_assignment" "external_directory_developer_to_importer" {
  provider            = azuread.external_directory
...
resource "azuread_app_role_assignment" "external_directory_developer_to_reference_reader" {
  provider            = azuread.external_directory
...
resource "azuread_app_role_assignment" "external_directory_developer_to_robot_writer" {
  provider            = azuread.external_directory
  app_role_id         = azuread_application_app_role.external_directory_robot_writer.role_id
  principal_object_id = var.developers_group_id
  resource_object_id  = azuread_service_principal.external_directory_destiny_repository.object_id
}

resource "azuread_app_role_assignment" "external_directory_developer_to_enhancement_request_writer" {
  provider            = azuread.external_directory
  app_role_id         = azuread_application_app_role.external_directory_enhancement_request_writer.role_id
  principal_object_id = var.developers_group_id
  resource_object_id  = azuread_service_principal.external_directory_destiny_repository.object_id
}
