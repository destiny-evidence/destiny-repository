...
def test_polling_pending_enhancements():
    ...
    with httpx.Client(base_url=repo_url) as repo_client:
        ...
        # Create a enhancement request to generate pending enhancements
        request_in = destiny_sdk.robots.EnhancementRequestIn(
        ...
        for _ in range(2):
            ...
            result = destiny_sdk.robots.RobotRequest.model_validate(response.json())
