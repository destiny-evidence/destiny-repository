...
def _read_references():
    ...
    with open(test_data_path, encoding="utf-8") as test_references_file:
...
def test_annotations():
    ...
    expected = [
        ...
        ({'scheme': 'inclusion:destiny', 'label': 'Included in DESTINY domain'},
         [True, None, True, False, False, True, True, True, False, True]),
        ({'scheme': 'inclusion:destiny', 'label': 'Included in DESTINY domain', 'expected_value': False},
         [False, None, False, True, True, False, False, False, True, False]),
        ({'scheme': 'classifier:taxonomy:Context', 'label': 'Coastal socioecological systems'},
    ...
    for params, expected_values in expected:
        for ref, expected_value in zip(_read_references(), expected_values):
...
def test_titles():
    ...
    expected = [
        ...
        'Microbiological Evaluation of Biodegradation Processes of Solid Waste in Reclaimed Landfills',
    ...
    for ref, expected_value in zip(_read_references(), expected):
...
def test_biblio():
    ...
    expected = {
        'doi': [
            '10.58830/ozgur.pub782', None, '10.1080/0886022x.2025.2517403',
            '10.54740/ros.2025.028', '10.31814/stce.huce2025-19(2)-11', '10.1016/s0140-6736(14)61878-x',
            '10.1111/issj.12473', '10.1007/s10113-023-02136-w', '10.3390/diseases11040157',
            '10.36347/sasjs.2023.v09i10.007'
        ],
        'publication_year': [
            2025, None, 2025, 2025, 2025, None, 2023, 2023, 2023, None
        ],
        'openalex_id': [
            'W4411634280', 'W4411634320', 'W4411634759', 'W4411698874', 'W4411698892',
            'W1965074043', 'W4388230581', 'W4388231242', 'W4388231278', 'W4388232129'
        ],
        'pubmed_id': [
            None, 40562693, 40562394, None, None, None, None, None, 37987268, None
        ]
    }
