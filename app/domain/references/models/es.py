...
class ExternalIdentifierDocument(InnerDoc):
    ...
    def to_domain(self, reference_id: UUID7) -> LinkedExternalIdentifier:
...
class EnhancementDocument(InnerDoc):
    ...
    id: UUID7 = mapped_field(Keyword(required=True, index=True))
    ...
    def to_domain(self, reference_id: UUID7) -> Enhancement:
