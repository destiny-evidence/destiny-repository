...
.. mermaid::
    :caption: Domain Router Structure
...
- **Service**
  ...
  - Note that some functions are decorated with UoWs, and others aren't. Careful decision needs to be made regarding where the UoW boundary is drawn. Don't worry, if you try to call a decorated function from within a decorated function, the app will notify you!
