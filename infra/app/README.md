...
| <a name="input_auth_provider"></a> [auth_provider](#input_auth_provider)                                                    | Authentication provider to use for JWT validation. One of: azure, keycloak, both.                       | `string` | `"azure"`                               |    no    |
...
| <a name="input_shared_container_registry_name"></a> [shared_container_registry_name](#input_shared_container_registry_name) | Name of the shared container registry. Sourced from the destiny-evidence-shared TFC variable set.       | `string` | n/a                                     |   yes    |
| <a name="input_shared_keycloak_url"></a> [shared_keycloak_url](#input_shared_keycloak_url)                                  | Public-facing Keycloak base URL. Sourced from the destiny-evidence-shared TFC variable set.             | `string` | n/a                                     |   yes    |
| <a name="input_shared_resource_group_name"></a> [shared_resource_group_name](#input_shared_resource_group_name)             | Resource group containing shared infrastructure. Sourced from the destiny-evidence-shared variable set. | `string` | n/a                                     |   yes    |
