...
class ReferenceService(GenericService[ReferenceAntiCorruptionService]):
    ...
    async def register_search_enhancement_request(
        ...
        return await self._enhancement_service.register_search_enhancement_request(
            enhancement_request
        )
    ...
    async def collect_pending_enhancements_from_search(
        ...
        enhancement_request = (
            await self._enhancement_service.claim_search_enhancement_request(
        ...
        if enhancement_request.search is None:
            await self._enhancement_service.fail_search_enhancement_request(
        ...
        try:
            ...
            await self._enhancement_service.complete_search_enhancement_request(
                enhancement_request_id
            )
    ...
    async def get_search_enhancement_request(
        ...
        return await self._enhancement_service.get_search_enhancement_request(
            enhancement_request_id
        )
