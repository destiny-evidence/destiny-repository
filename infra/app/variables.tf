...
variable "expire_pending_enhancements_batch_size" {
  description = "Maximum number of stale pending enhancements expired and replaced by a single run of the expire_pending_enhancements job"
  type        = number
  default     = 10000
}
