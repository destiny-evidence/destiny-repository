...
async def collect_and_dispatch_references_for_enhancement(
    enhancement_request_id: UUID4 | UUID7,
) -> None:
...
async def process_reference_duplicate_decision(
    reference_duplicate_decision_id: UUID4 | UUID7,
) -> None:
...
async def detect_and_dispatch_robot_automations(
    ...
    reference_ids: Iterable[UUID4 | UUID7] | None = None,
    enhancement_ids: Iterable[UUID4 | UUID7] | None = None,
    source_str: str | None = None,
    skip_robot_id: UUID4 | UUID7 | None = None,
