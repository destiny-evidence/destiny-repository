...
async def validate_import_record(
    import_record_id: Annotated[UUID7, Path(description="The id of the import")],
...
async def finalise_record(
    import_record_id: Annotated[
        UUID7, Path(description="The id of the import to finalise")
    ],
    import_service: Annotated[ImportService, Depends(import_service)],
) -> None:
...
async def enqueue_batch(
    import_record_id: Annotated[
        UUID7, Path(description="The id of the associated import")
    ],
...
async def get_batch(
    import_batch_id: Annotated[UUID7, Path(description="The id of the import batch")],
    import_service: Annotated[ImportService, Depends(import_service)],
    import_anti_corruption_service: Annotated[
        ImportAntiCorruptionService, Depends(import_anti_corruption_service)
    ],
