...
class ReferenceDuplicateDeterminationResult(BaseModel):
    ...
    canonical_reference_id: UUID7 | None = Field(
        default=None,
...
class ReferenceDuplicateDecision(DomainBaseModel, SQLAttributeMixin):
    ...
    reference_id: UUID7 = Field(description="The ID of the reference being evaluated.")
    enhancement_id: UUID7 | None = Field(
        default=None,
        description=(
    ...
    candidate_canonical_ids: list[UUID7] = Field(
...
class PendingEnhancement(DomainBaseModel, SQLAttributeMixin):
    ...
    enhancement_request_id: UUID7 = Field(
        ...,
        description=(
    ...
    robot_enhancement_batch_id: UUID7 | None = Field(
        default=None,
        description=(
