...
class DerivedEnhancementNotFoundError(Exception):
    """Exception for when a derived enhancement is not found."""

    def __init__(self, detail: str, *args: object) -> None:
        """
        Initialize the DerivedEnhancementNotFoundError exception.
