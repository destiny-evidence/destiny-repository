...
def upgrade() -> None:
    op.alter_column('import_result', 'status',
        existing_type=postgresql.ENUM('created', 'started', 'completed', 'cancelled', 'partially_failed', 'failed', 'retrying', name='import_result_status'),
        type_=sa.String(),
